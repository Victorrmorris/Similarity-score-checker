...
if st.button("Submit"):
    ...
    similarity = similarity_score(job_description_a, job_description_b, model)
...
def main():
    ...
    with st.form(key = 'form1', clear_on_submit=False):
        Job_design1 = st.text_area("Job design", value=demo_1)
        Job_description2 = st.text_area("Job description",value=demo_2)
        Job_description3 = st.text_area("Job description",value=demo_3)
        Job_description4 = st.text_area("Job description",value=demo_4)
        Job_description5 = st.text_area("Job description",value=demo_5)
